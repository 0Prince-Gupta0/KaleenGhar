...
>
  ...
  {/* ================= FILTER GROUPS ================= */}
  <div className="px-4 sm:px-5 py-4 sm:py-6 space-y-6 sm:space-y-8 max-h-[70vh] overflow-y-auto">
        ...
        <div key={key}>
          ...
          >
            <div className="flex items-center gap-2">
              <h3 className="text-xs sm:text-sm font-semibold uppercase tracking-wide text-[#374151]">
                {key}
              </h3>
